...
export default function Automations() {
  ...
  // EHN AI Powered Report Generation & Dispatch
  const handleRunEhnAIReport = async (autoItem) => {
  ...
  return (
    <div className="py-2">
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
        <div>
          <div className="d-flex align-items-center gap-2 mb-0.5">
            <h4 className="fw-bold text-dark mb-0" style={{ letterSpacing: '-0.4px' }}>WhatsApp EHN AI Automation & Auto-Reply Bot Engine</h4>
      ...
      <div className="card border-0 shadow-sm mb-3" style={{ borderRadius: 12 }}>
        <div className="card-body p-2 d-flex flex-wrap align-items-center justify-content-between gap-2" style={{ background: '#f8faf9', borderRadius: 12 }}>
          <div className="nav nav-pills gap-1">
            ...
            >
              <i className="bi bi-chat-dots-fill me-1 text-success"></i> 1. Auto-Reply Bot ({autoReplyRules.length})
            </button>
            <button
            ...
            >
              <i className="bi bi-robot me-1 text-primary"></i> 2. EHN AI Reports ({automationsList.length})
            </button>
            <button
            ...
            >
              <i className="bi bi-alarm me-1 text-warning"></i> 3. Reminders ({reminders.length})
            </button>
            <button
      ...
      {/* TAB 2: EHN AI SYSTEM REPORTS ENGINE */}
      {activeTab === 'setup' && (
        <div className="row g-3">
          <div className="col-12">
            <div className="p-2.5 rounded-3 d-flex flex-wrap align-items-center justify-content-between gap-2 border bg-white shadow-sm" style={{ borderColor: '#DAF2DB' }}>
      ...
      {/* SCHEDULE REMINDER MODAL (HIGH VISIBILITY TEXT HEADER FIX) */}
      {showTaskModal && (
        <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) setShowTaskModal(false); }}>
          <div className="modal-box" style={{ maxWidth: 520 }}>
            <div className="modal-box-header d-flex align-items-center justify-content-between px-4 py-3" style={{ background: '#1E4D2B', color: '#ffffff', borderRadius: '12px 12px 0 0' }}>
              <span className="fw-bold text-white d-flex align-items-center gap-2" style={{ fontSize: '1.05rem' }}>
                <i className="bi bi-alarm-fill text-warning"></i> Schedule WhatsApp Reminder
              </span>
              ...
              <div className="modal-box-body p-4 bg-white">
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    className="form-control fw-semibold"
                    placeholder="e.g. Thursday Supplier Meeting, Payment Follow-up"
                ...
                <div className="row g-3 mb-3">
                  ...
                  <div className="col-6">
                    <label className="form-label fw-bold text-dark">Time (24h)</label>
                ...
                <div className="mb-3">
                  <label className="form-label fw-bold text-dark">Recipient Mobile Number <span className="text-danger">*</span></label>
                ...
                <div className="mb-3">
                  <label className="form-label fw-bold text-dark">Message Text</label>
                  <textarea className="form-control fw-semibold" rows="3" value={taskForm.message} onChange={(e) => setTaskForm({ ...taskForm, message: e.target.value })}></textarea>
                </div>
              </div>
              <div className="modal-box-footer d-flex justify-content-end gap-2 p-3 bg-light" style={{ borderRadius: '0 0 12px 12px' }}>
